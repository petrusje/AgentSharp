...
{
  /// <summary>
  /// Provides global constant values used throughout the AgentSharp library.
  /// </summary>
  /// <remarks>
  ...
  {
    /// <summary>
    /// The current version of the AgentSharp library.
    /// </summary>
    /// <remarks>
  ...
  /// <summary>
  /// Manages global configuration settings for the AgentSharp library.
  /// </summary>
  /// <remarks>
