...
namespace Agents.net.Utils
{
    ...
    public static class StructuredOutputExtensions
    {
        ...
        {
            return response.TryGetStructuredData<T>(out data);
        }
        ...
        public static T GetStructuredDataOrDefault<T>(this ModelResponse response, T defaultValue = default(T))
        {
            if (response.TryGetStructuredData<T>(out T data))
            {
                return data;
            }
            return defaultValue;
        ...
        public static TResult MapStructuredData<T, TResult>(this ModelResponse response, Func<T, TResult> transform, TResult defaultValue = default(TResult))
        {
            if (response.TryGetStructuredData<T>(out T data))
            {
