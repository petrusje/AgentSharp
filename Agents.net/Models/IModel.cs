...
namespace Arcana.AgentsNet.Models
{
  ...
  public interface IModel
  {
    ...
    Before:
            /// <exception cref="Agents.net.Exceptions.ModelException">Thrown when the model fails to generate a response</exception>
            /// <exception cref="Agents.net.Exceptions.AuthorizationException">Thrown when there's an authentication or authorization error</exception>
            Task<ModelResponse> GenerateResponseAsync(
    After:
            /// <exception cref="Arcana.AgentsNet.Exceptions.ModelException">Thrown when the model fails to generate a response</exception>
            /// <exception cref="Arcana.AgentsNet.Exceptions.AuthorizationException">Thrown when there's an authentication or authorization error</exception>
            Task<ModelResponse> GenerateResponseAsync(
    */
    ...
    /* Unmerged change from project 'Arcana.AgentsNet (netstandard2.0)'
    Before:
            /// <exception cref="Agents.net.Exceptions.ModelException">Thrown when the model fails during streaming</exception>
            /// <exception cref="Agents.net.Exceptions.AuthorizationException">Thrown when there's an authentication or authorization error</exception>
            /// <remarks>
    After:
            /// <exception cref="Arcana.AgentsNet.Exceptions.ModelException">Thrown when the model fails during streaming</exception>
            /// <exception cref="Arcana.AgentsNet.Exceptions.AuthorizationException">Thrown when there's an authentication or authorization error</exception>
            /// <remarks>
    */
